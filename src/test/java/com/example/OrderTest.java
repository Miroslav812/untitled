...
public class OrderTest {
    ...
    private static Stream<Object[]> orderDataProvider() {
        return Stream.of(
                new Object[]{"Иван", "Петров", "ул. Ленина, 1", "Сокольники", "+79123456789",
                        "01.01.2025", "сутки", "black", "Комментарий 1", true},
                new Object[]{"Мария", "Сидорова", "пр. Мира, 25", "Черкизовская", "+79234567890",
                        "15.01.2025", "двое суток", "grey", "Комментарий 2", false}
        );
    }
